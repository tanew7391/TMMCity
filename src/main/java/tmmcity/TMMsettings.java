...
public class TMMsettings extends BasicGameState {
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException{
        ...
        switch (difficulty) {
            case 1: g.drawString("Sandbox", 700, 933);
                break;
            case 2: g.drawString("Easy", 700, 933);
                break;
            case 4: g.drawString("Hard", 700, 933);
                break;
            default: g.drawString("Normal", 700, 933);
                break;
        }
